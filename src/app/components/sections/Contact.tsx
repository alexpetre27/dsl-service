      ...
      <Container>
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Programează-te pentru o consultație sau service. Suntem aici să te
            ajutăm cu orice întrebare.
          </p>
        </div>
              ...
              <div className="space-y-6">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">0767 601 122</p>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">dslgarage.contact@gmail.com</p>
                    <p className="text-sm text-gray-500">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Comuna Râfov, Sat Buda</p>

  ...
  const equipment = [
    {
      ...
      description: 'Echipament de ultimă generație pentru diagnoză computerizată avansată',
    ...
    },
    {
      ...
      description: 'Sistem de ridicare profesional pentru acces complet sub vehicul',
    ...
    },
    {
      ...
      description: 'Echipament modern pentru service-ul sistemelor de climatizare',
      features: ['Compatibil R134a/R1234yf', 'Recirculare agent', 'Vacuum profesional'],
      image: '[Stație climatizare cu afișaj digital și furtunuri]'
    },
    {
      icon: 'shield',
      title: 'Cameră de vopsit cu filtrare',
      description: 'Cameră profesională pentru lucrări de caroserie și vopsitorie',
    ...
    },
    {
      ...
      description: 'Arsenal complet de unelte specializate pentru fiecare marcă',
      features: ['Unelte originale', 'Chei dinamometrice', 'Extractor injectoare'],
      ...
      <Container>
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Investim continuu în echipamente moderne pentru a oferi servicii la standarde premium
          </p>
        </div>
        ...
        <div className="mt-16 bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
          <div className="grid md:grid-cols-3 gap-8 text-center">
            <div>
              ...
              <p className="text-gray-600">Ani de experiență cu echipamente profesionale</p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="text-gray-600">Mărci premium deservite cu echipamente dedicate</p>
            </div>
          </div>
        </div>
      </Container>

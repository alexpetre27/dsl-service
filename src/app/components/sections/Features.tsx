...
export default function Features() {
  const features = [
    ...
    },
    {
      ...
      description: 'Documentație clară pentru fiecare lucrare și recomandări următoare.'
    },
    {
      id: 'feat-3',
      icon: ShieldCheck,
    ...
    <Section className="bg-white">
      <Container>
        <div className="text-center space-y-4 mb-12">
          <h2 className="text-3xl md:text-4xl font-semibold tracking-tight">Beneficii rapide</h2>

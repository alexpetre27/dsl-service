...
export default function Hero() {
  ...
  return (
    <Section id="home" className="relative overflow-hidden pt-20 sm:pt-24 lg:pt-28 pb-0">
      {/* Background (light) */}
      <div className="absolute inset-0 bg-gradient-to-br from-gray-50 via-white to-white" />
      {/* Gold aura accents */}
      <div className="absolute -top-24 -right-20 w-[36rem] h-[36rem] rounded-full opacity-20 blur-3xl"
           style={{ background: 'radial-gradient(closest-side, #D6BD98, transparent 70%)' }} />
      <div className="absolute bottom-[-8rem] -left-24 w-[40rem] h-[40rem] rounded-full opacity-10 blur-3xl"
           style={{ background: 'radial-gradient(closest-side, #D6BD98, transparent 70%)' }} />
        ...
        <div className="grid lg:grid-cols-12 gap-10 w-full items-center">
          ...
          <div className="lg:col-span-7 text-gray-900">
            <div className="inline-flex items-center gap-2 bg-accent/10 px-4 py-2 rounded-full mb-6 border border-accent/20">
              ...
              <span className="text-sm font-medium">Service auto premium • Stație ITP autorizată</span>
            </div>

            <h1 className="text-5xl md:text-6xl xl:text-7xl font-bold tracking-tight leading-tight mb-6">
              Excelență în service auto
              <span className="block mt-1 bg-clip-text text-transparent" style={{
                backgroundImage: 'linear-gradient(135deg,#111111,#D6BD98)'
              }}>pentru mărci PREMIUM</span>
            </h1>

            <p className="text-lg md:text-xl text-gray-600 max-w-2xl leading-relaxed mb-10">
              Întreținere, diagnoză și reparații cu standarde de showroom. Rapid, transparent, garantat.
            </p>

            <div className="flex flex-col sm:flex-row gap-4 sm:gap-6">
              <Button size="lg" className="px-8" onClick={() => scrollTo('itp-section')}>
          ...
          <div className="lg:col-span-5 hidden lg:block">
            <div className="grid grid-cols-2 gap-6">
              <div className="rounded-2xl p-6 shadow-sm bg-white border border-gray-200">
                ...
                <h3 className="text-gray-900 font-semibold mb-1">Diagnoză avansată</h3>
                <p className="text-gray-600 text-sm">Echipamente OEM pentru mărci premium</p>
              </div>
              <div className="rounded-2xl p-6 shadow-sm bg-white border border-gray-200">
                <div className="w-12 h-12 rounded-xl bg-accent/20 flex items-center justify-center mb-4">
                  <Icon name="shield" size={22} className="text-accent" />
                </div>
                <h3 className="text-gray-900 font-semibold mb-1">Stație ITP</h3>
                <p className="text-gray-600 text-sm">Autorizată RAR, raport clar</p>
              </div>
              <div className="rounded-2xl p-6 shadow-sm bg-white border border-gray-200 col-span-2">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-900 text-lg font-semibold">Peste 1000 în ultimii 3 ani</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      {/* Light top fade to header (subtle) */}

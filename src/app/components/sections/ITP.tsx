      ...
      <Container>
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Oferim servicii complete de inspecție tehnică periodică pentru toate tipurile de vehicule, 
            cu echipamente moderne și personal certificat RAR.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center mb-16">
          <div>
            <div className="grid sm:grid-cols-2 gap-6">
              {itpSteps.map((step, index) => (
                <Card key={index} className="group relative hover:shadow-xl transition-shadow border border-gray-100 rounded-2xl">
                  <div className="flex items-start gap-5 md:gap-6">
                    ...
                    <div className="pt-1">
                      <h3 className="text-xl font-semibold text-gray-900 leading-tight mb-1.5">{step.title}</h3>
          ...
          <div className="relative">
            {/* Placeholder for ITP station image */}
        ...
        <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
          <div className="grid md:grid-cols-3 gap-8 mb-8">
            <div className="text-center">
              ...
              <h3 className="font-semibold text-gray-900 mb-2">Programări în aceeași zi</h3>
              <p className="text-gray-600 text-sm">Flexibilitate maximă pentru programul tău</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="font-semibold text-gray-900 mb-2">Verificări complete</h3>
              <p className="text-gray-600 text-sm">Toate componentele verificate conform normelor</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm">Explicații detaliate pentru toate verificările</p>
            </div>
          </div>

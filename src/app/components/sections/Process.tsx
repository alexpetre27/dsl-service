  ...
  const processSteps = [
    {
      icon: 'check',
      title: 'Recepție',
      description: 'Primirea vehiculului și discutarea problemelor identificate de client',
      detail: 'Înregistrarea vehiculului cu toate detaliile necesare'
    },
    {
      icon: 'wrench',
      title: 'Diagnoză',
      description: 'Diagnoză computerizată completă pentru identificarea exactă a problemelor',
      detail: 'Scanare avansată și testare a tuturor sistemelor'
    },
    {
      icon: 'document',
      title: 'Ofertă transparentă',
      description: 'Prezentarea unei oferte detaliate cu explicații pentru fiecare lucrare',
      detail: 'Prețuri clare, fără costuri ascunse'
    },
    {
      icon: 'star',
      title: 'Execuție',
      description: 'Realizarea lucrărilor cu piese de calitate și atenție la detalii',
      detail: 'Utilizarea unor echipamente profesionale moderne'
    },
    {
      icon: 'shield',
      title: 'QC în 50 puncte',
      description: 'Control de calitate în 50 de puncte înainte de predarea vehiculului',
      detail: 'Verificări sistematice pentru siguranță și performanță'
    },
    {
      icon: 'heart',
      title: 'Predare & follow-up',
      description: 'Predarea vehiculului cu explicații și urmărirea satisfacției clientului',
      ...
      <Container>
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Un workflow structurat pentru rezultate de încredere, de fiecare dată
          </p>
        </div>
        ...
        <div className="mt-16 text-center">
          <div className="inline-flex items-center gap-4 bg-accent/5 px-8 py-6 rounded-2xl">
            ...
            <div className="text-left">
              <p className="font-semibold text-gray-900 text-lg">Timpul mediu de execuție</p>
              <p className="text-gray-600">Servicii standard: 2-4 ore • Reparații complexe: 1-3 zile</p>
            </div>
          </div>
        </div>
    </Container>

  ...
  const services = [
    {
      ...
      description: 'Diagnoză completă cu echipamente de ultimă generație pentru identificarea precisă a problemelor.',
      features: ['Scanner multimarcă', 'Raport detaliat', 'Interpretare profesională']
    },
    {
      icon: 'check',
      title: 'Sistem climatizare',
      description: 'Service complet pentru sistemele de climatizare: verificare, reîncărcare, reparații.',
      features: ['Verificare presiuni', 'Reîncărcare R1234yf', 'Dezinfectare sistem']
    },
    {
      icon: 'shield',
      title: 'Frâne & suspensie',
      description: 'Verificări și reparații pentru sistemele de frânare și suspensie, cruciale pentru siguranță.',
      features: ['Plăcuțe și discuri', 'Amortizoare', 'Test pe stand']
    },
    {
      icon: 'clock',
      title: 'Revizie & întreținere',
      description: 'Revizii periodice conform recomandărilor producătorului pentru a menține performanțele.',
      features: ['Revizie completă', 'Uleiuri premium', 'Check-up 50 puncte']
    },
    {
      icon: 'wrench',
      title: 'Reparații mecanice',
      description: 'Reparații complexe pentru motoare, transmisii și alte componente mecanice.',
      features: ['Reparații motor', 'Transmisie', 'Piese originale']
    },
    {
      icon: 'check',
      title: 'Schimb ulei & filtre',
      description: 'Schimb rapid de ulei și filtre cu produse premium adaptate fiecărei mărci.',
    ...
    },
    {
      ...
      description: 'Verificare și reglare geometrie roți pentru uzură uniformă a anvelopelor.',
      features: ['Măsurare 3D', 'Reglare precisă', 'Test drive']
    },
    {
      icon: 'wrench',
      title: 'Electrică auto',
      description: 'Diagnoză și reparații pentru toate sistemele electrice și electronice.',
      features: ['Diagnoză avansată', 'Reparații cablaje', 'Programări ECU']
    },
    {
      icon: 'star',
      title: 'Caroserie & vopsitorie',
      description: 'Servicii complete de caroserie și vopsitorie în cameră cu filtrare profesională.',
      ...
      <Container>
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Gamă completă de servicii pentru întreținerea și repararea vehiculelor premium, 
            cu echipamente moderne și personal specializat.
          </p>
        </div>
              ...
              <CardContent>
                ...
                <ul className="space-y-2.5 mb-6">
                  {service.features.map((feature, featureIndex) => (
                    <li key={featureIndex} className="flex items-center gap-2.5 text-sm text-gray-600">
        ...
        <div className="text-center">
          <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100 max-w-4xl mx-auto">
            ...
            <p className="text-gray-600 mb-6">
              Contactează-ne pentru servicii personalizate sau consultații tehnice pentru vehiculul tău premium.
            </p>

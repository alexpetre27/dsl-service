  ...
  const reasons = [
    {
      ...
      description: 'Peste un deceniu de lucru cu cele mai prestigioase mărci auto'
    },
    {
      icon: 'check',
      title: 'Piese de calitate',
      description: 'Folosim exclusiv piese originale și echivalente premium certificate'
    },
    {
      icon: 'shield',
      title: 'Garanție lucrări',
      description: 'Toate serviciile beneficiază de garanție extinsă pentru liniștea ta'
    },
    {
      icon: 'heart',
      title: 'Prețuri corecte',
      description: 'Transparență completă în prețuri, fără costuri ascunse sau surprize'
    },
    {
      icon: 'star',
      title: 'Personal certificat',
      description: 'Mecanici cu certificări și pregătire continuă pentru fiecare marcă'
    },
    {
      icon: 'clock',
      title: 'Respectarea termenelor',
      description: 'Livrăm vehiculul la timp, conform termenului stabilit împreună'
    },
    {
      icon: 'wrench',
      title: 'Echipamente moderne',
      description: 'Investim constant în cele mai noi tehnologii și echipamente'
    },
    {
      icon: 'eye',
      title: 'Consultanță gratuită',
      description: 'Oferim consiliere tehnică gratuită pentru întreținerea optimă'
    },
    {
      icon: 'document',
      ...
      <Container>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-8 mb-20">
          {reasons.map((reason, index) => (
            ...
            >
              {/* Hover accent glow */}
              <div className="pointer-events-none absolute inset-0 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300" style={{background: 'linear-gradient(135deg, rgba(214,189,152,0.10), rgba(214,189,152,0.04))'}} />
        ...
        <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
          <div className="grid md:grid-cols-4 gap-8 text-center">
            ...
            <div>
              ...
              <p className="text-gray-500 text-sm mt-1">conform feedback-ului</p>
            </div>
            <div>
              <div className="text-4xl font-bold text-accent mb-2">2.5h</div>
              <p className="text-gray-600 font-medium">Timp mediu service</p>
              <p className="text-gray-500 text-sm mt-1">pentru servicii standard</p>
            </div>
            <div>
        ...
        <div className="mt-16 text-center">
          <h3 className="text-2xl font-bold text-gray-900 mb-8">Certificări și autorizări</h3>
